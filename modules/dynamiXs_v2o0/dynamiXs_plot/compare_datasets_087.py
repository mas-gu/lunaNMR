...
def get_available_columns_for_comparison(df1, df2):
    ...
    spectral_density_cols = [col for col in data_cols if any(x in col for x in ['J0', 'JwN', 'JwH_087'])]
...
def interactive_mode():
    ...
    print("Examples: R1,R2,hetNOE,J0,JwN,JwH_087,S2,te,Rex")
