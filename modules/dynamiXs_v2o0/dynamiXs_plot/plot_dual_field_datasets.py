#!/usr/bin/env python3
"""
Standalone script for plotting dual-field NMR relaxation data from 
ZZ_multi_2fields_density_claude_rex_mcmc_errorFIX.py output files.
...
def get_available_columns(df):
    ...
    spectral_density_cols = ['J0_f1', 'JwN_f1', 'JwH_f1', 'J0_f2', 'JwN_f2', 'JwH_f2']
...
def set_ylimits(ax, column, data):
    ...
    elif 'JwN' in column or 'JwH' in column:
        ax.set_ylim(0, data.max() * 1.2)
    elif 'S2' in column:
        ax.set_ylim(0, 1)
...
def interactive_mode():
    ...
    print("Examples: R1,R2,hetNOE,J0,JwN,JwH,Rex,S2,te")
